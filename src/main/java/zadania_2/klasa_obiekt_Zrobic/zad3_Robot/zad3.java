package zadania_2.klasa_obiekt_Zrobic.zad3_Robot;
/*
3.	Stwórz enum RuchRobota która posiada wartości:

        KROK_LEWA, KROK_PRAWA, RUCH_REKA_LEWA, RUCH_REKA_PRAWA, SKOK

        każdy z ruchów posiada również dodatkową informację (liczbową) która reprezentuje ile % baterii
        robota jest potrzebne do wykonania podanego ruchu.
        ...
        wlacz
        wylacz
        z linii poleceń w Main'ie.
*/

public class zad3 {
    //zrobione zadania 3 zad 7
}
