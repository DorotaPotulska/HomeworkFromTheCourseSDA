...
Zadanie 2:
        ...
        - dodajKlienta(String imie, boolean czyPriorytet):void - która dodaje klienta o podanym imieniu z informacją czy jest priorytetyzowany. W metodzie stwórz instancje klasy Klient i ustaw mu wartości wszystkich pól. Czas dodania ustaw na 'now()' czyli moment dodania go do kolejki.
