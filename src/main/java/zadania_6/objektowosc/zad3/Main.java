...
Zadanie 3:
        ...
        Pierwsze 4 są raczej oczywiste. Dzwoniący może zgłosić problem np. uszkodzenia na drodze,
        zgłoszenia wandalizmu lub innych rzeczy.
        ...
        - dodajZgloszenie(String tresc, TypZgloszenia typ):void - która tworzy nową instancję "Zgłoszenia" i dodaje je do mapy (spróbuj wymyślić unikalny identyfikator zgłoszenia) Wskazówka:  http://www.baeldung.com/java-uuid
